describe('test', () => {
  ...
  async function getString() {
    ...
    const subString = await new Cypress.Promise((resolve) => {
  ...
  // Additionally, in your function getString, you are already returning a Promise, you don't need async/await for that function.
})